...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="<?= site_url('') ?>assets/admin/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?= site_url('') ?>assets/admin/js/demo/chart-area-demo.js"></script>
  <script src="<?= site_url('') ?>assets/admin/js/demo/chart-pie-demo.js"></script>
